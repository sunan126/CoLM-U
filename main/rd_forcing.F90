...
SUBROUTINE rd_forcing(idate,solarin_all_band,s_year,s_month,s_day,s_seconds,deltim,s_julian,lc_year)
  ...
  use omp_lib
      ...
      integer,  INTENT(in) :: s_year, s_month, s_day, s_seconds, s_julian, lc_year
