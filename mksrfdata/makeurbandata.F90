...
!
! History:
!   09/2022: Wenzong Dong, initial version.
! ======================================================
         ...
         DO reglon_ = sreglon, ereglon, 5
            ...
            DO i = si, ei
               DO j = sj, ej
                  ...
                  IF (urden(j,i) > 0) THEN
                     ! Area-weighted average of urban buliding height/fraction/population density/
                     ! tree cover/tree height/water cover and LSAI for each NCAR urban
                     inx = int(urden(j,i))
...
#endif
                     ! Some grid points MODIS and NCAR are inconsistent (NCAR has no urban ID), 
