...
!---------------------------------------------------------------------
   ...
   SUBROUTINE writenetcdf
    ...
    ! dimension variables
      ...
      CALL sanity( nf90_def_var(ncid, 'f_t_room', nf90_double, (/xid,yid/), varid) )
      CALL sanity( nf90_put_att(ncid, varid, 'long_name','temperature of inner building [K]') )
      CALL sanity( nf90_put_att(ncid, varid, 'units','K') )
      CALL sanity( nf90_put_att(ncid, varid, 'missing_value', spval) )
      CALL sanity( nf90_put_att(ncid, varid, '_FillValue', spval) )
      ...
      CALL sanity( nf90_def_var(ncid, 'f_fwst', nf90_double, (/xid,yid/), varid) )
      CALL sanity( nf90_put_att(ncid, varid, 'long_name','waste heat flux from heat or cool AC [W/m2]') )
      CALL sanity( nf90_put_att(ncid, varid, 'units','W/m2') )
      CALL sanity( nf90_put_att(ncid, varid, 'missing_value', spval) )
      CALL sanity( nf90_put_att(ncid, varid, '_FillValue', spval) )
      ...
      CALL sanity( nf90_def_var(ncid, 'f_tafudt', nf90_double, (/xid,yid/), varid) )
      CALL sanity( nf90_put_att(ncid, varid, 'long_name','temperature of outer building in daytime [K]') )
      CALL sanity( nf90_put_att(ncid, varid, 'units','K') )
      CALL sanity( nf90_put_att(ncid, varid, 'missing_value', spval) )
      CALL sanity( nf90_put_att(ncid, varid, '_FillValue', spval) )
...
!---------------------------------------------------------------------
      ...
      ! temperature of inner building [K]
      CALL sanity( nf90_inq_varid(ncid,'f_t_room',varid) )
      CALL sanity( nf90_put_var(ncid,varid,f_t_room) )
      ...
      ! waste heat flux from heat or cool AC [W/m2]
      CALL sanity( nf90_inq_varid(ncid,'f_fwst',varid) )
      CALL sanity( nf90_put_var(ncid,varid,f_fwst) )
