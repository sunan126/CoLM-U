...
#-------------------------------------------------------
set CASE_NAME   = LCZ_real           	# case name                                            <MARK #1>
...
# clm src directory
#-------------------------------------------------------
setenv CLM_ROOT   /hard/dongwz/LULCC/LUCY-CoLM                  # <MARK #3>
...
# inputdata directory
setenv DAT_ROOT   /home/yuanhua/data/inputdata                 # <MARK #4>
setenv DAT_RAWDIR /home/yuanhua/data/CLMrawdata
...
# case directory
#-------------------------------------------------------
setenv CAS_ROOT   /tera01/dongwz/casess                   # <MARK #5>
...
if ( $use_mpi == "YES" ) then
    ...
    ./clmu.x < $CAS_RUNDIR/timeloop.stdin
endif
